        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">اضافه کردن کاربر <a target="_blank"
                            ...
                            <div class="table-responsive">
                                <form action="@if(isset($User)){{route('User.update',$User)}}@else{{route('User.store')}}@endif" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control col-5" type="text" name="phonenumber" value="@isset($User){{$User->phonenumber}}@endisset">


                                    </div>
                                    <div class="form-group">
                                        <label for="Password">Password</label>
                                        <input class="form-control col-5" type="text" name="password">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control col-5" name="lastname" value="@isset($User){{$User->Profile->lastname}}@endisset">
                                    </div>
                                    <div class="form-group">
                                        <label for="avatar">عکس پروفایل</label>

                                        <input type="file"class="form-control col-5" name="avatar" >
                                    </div>
                                    <div class="form-group">
                                        @isset($User)
