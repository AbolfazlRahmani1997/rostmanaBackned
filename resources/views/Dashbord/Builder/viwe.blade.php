                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-4 text-gray-800 justify-content-center">{{$builder->name}}</h1>
                        <div class="card justify-content-center "><div class="card-header ">
                            ...
                            <div class="card-body ">
                                <div class="card-title justify-content-center mx-auto d-flex font-weight-bold"> {{$builder->model}}مدل</div>
                                <div class="card-title justify-content-center mx-auto d-flex font-weight-bold">عرض{{$builder->width}}</div>
                                <div class="card-title justify-content-center mx-auto d-flex font-weight-bold">طول: {{$builder->length}}</div>
                                <div class="card-title justify-content-center mx-auto d-flex font-weight-bold">طول: {{$builder->picture}}</div>
                                <div class="card-title justify-content-center mx-auto d-flex font-weight-bold">مدل: {{$builder->gender->name}}</div>
                                <div class="card-title justify-content-center mx-auto d-flex font-weight-bold">نوع اب یاری : {{$builder->watermode->name}}</div>
                            </div>
                        </div>
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">گیاهان در سازه</div>
                        </div>
<div class="card-body">
    <form action="{{route('PtB',$builder->id)}}" method="post">
        ...
        <div class="row form-group ">
            ...
            <button class="col-3 mx-1 btn btn-sm btn-success btn">اضافه  گیاه به  این سازه</button>
        </div>
    </form>
    <table id="plant_table">
        ...
        <tbody>
                        ...
                        <div class="card">
                            <div class="card-header">
                                 <div class="card-title">اخرین وضیعیت</div>
                            </div>
                            <div class="card-body">
                                <div class="status-indicator">
                                    <table class="table">
                                        <tr>
                                            <td>وضعیت بخار پاش</td>
                                            <td>وضعیت فن</td>
                                            <td>وضعیت مه پاش</td>
                                            <td>وضعیت نور</td>
